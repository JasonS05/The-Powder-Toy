...
struct ConfigStruct {
	...
	float pressureScale = std::log(50.0) / 256.0; // determines the exponential relationship between TPT pressure and simulation pressure, larger number means more extreme pressure swings for the same change in TPT pressure
};
